...
A token is used in Client side authentication in order to make sure a user has logged in.

- [x] What steps can you take in your web apps to keep your data secure?

You can impletement Private Routes and lock your data down to only users that have authenticated successfully.

- [x] Describe how web servers work.

When a user navigates to a web server in their browser, your web server "serves" the request to the end machine requesting it.
